...
public class OrderInfoUtil {
	...
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2,AliPayOrder aliPayOrder) {
		...
		keyValues.put("biz_content", "{\"timeout_express\":\""+aliPayOrder.getTimeout_express()+"\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\""+aliPayOrder.getTotal_amount()+"\",\"subject\":\""+aliPayOrder.getSubject()+"\",\"body\":\""+aliPayOrder.getBody()+"\",\"out_trade_no\":\"" + aliPayOrder.getOut_trade_no() +  "\"}");
