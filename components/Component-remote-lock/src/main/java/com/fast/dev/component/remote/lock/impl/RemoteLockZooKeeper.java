...
import com.fast.dev.component.remote.lock.exception.ServerErrorException;
...
public class RemoteLockZooKeeper extends RemoteLock {
	...
	// 默认配置
	public RemoteLockOption option;
	// 当前客户端
	public ZooKeeper zk;
	// 资源锁
	 ...
	 */
	public RemoteLockZooKeeper(RemoteLockOption option) throws IOException, KeeperException, InterruptedException {
		super(option);
		this.option = option;
		// 创建客户端
		createClient();
