...
public class MongodbConfiguration {
	 ...
	 */
	@Bean
	public MongoDbFactory mongoDbFactory(MongodbConfig mongodbConfig) {
		// 数据库账号
	 ...
	 */
	@Bean
	public GridFsTemplate gridFsTemplate(MongodbConfig mongodbConfig) {
		MongoDbFactory mongoDbFactory = mongoDbFactory(mongodbConfig);
	...
	@Bean
	public MongoTemplate mongoTemplate(MongodbConfig mongodbConfig) {
		return new MongoTemplate(mongoDbFactory(mongodbConfig));
	}
